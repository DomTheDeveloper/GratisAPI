...
# name, title, description, list-of-terms
_SEQUENCES = [
    ("primes", "Prime Numbers", "The first 10,000 prime numbers.", _first_primes(10000)),
    ...
    ("square-numbers", "Square Numbers", "Perfect squares n^2 for n = 1..10000.", _poly(lambda n: n * n, 10000)),
    ("cube-numbers", "Cube Numbers", "Perfect cubes n^3 for n = 1..2000.", _poly(lambda n: n ** 3, 2000)),
    ("fourth-powers", "Fourth Powers", "n^4 for n = 1..1000.", _poly(lambda n: n ** 4, 1000)),
    ("fifth-powers", "Fifth Powers", "n^5 for n = 1..500.", _poly(lambda n: n ** 5, 500)),
    ("triangular-numbers", "Triangular Numbers", "n(n+1)/2 for n = 1..10000.", _poly(lambda n: n * (n + 1) // 2, 10000)),
    ("tetrahedral-numbers", "Tetrahedral Numbers", "n(n+1)(n+2)/6 for n = 1..3000.", _poly(lambda n: n * (n + 1) * (n + 2) // 6, 3000)),
    ("square-pyramidal-numbers", "Square Pyramidal Numbers", "n(n+1)(2n+1)/6 for n = 1..3000.", _poly(lambda n: n * (n + 1) * (2 * n + 1) // 6, 3000)),
    ("pentagonal-numbers", "Pentagonal Numbers", "n(3n-1)/2 for n = 1..5000.", _poly(lambda n: n * (3 * n - 1) // 2, 5000)),
    ("hexagonal-numbers", "Hexagonal Numbers", "n(2n-1) for n = 1..5000.", _poly(lambda n: n * (2 * n - 1), 5000)),
    ("heptagonal-numbers", "Heptagonal Numbers", "n(5n-3)/2 for n = 1..5000.", _poly(lambda n: n * (5 * n - 3) // 2, 5000)),
    ("octagonal-numbers", "Octagonal Numbers", "n(3n-2) for n = 1..5000.", _poly(lambda n: n * (3 * n - 2), 5000)),
    ...
    ("happy-numbers", "Happy Numbers", "The first 1,000 happy numbers.", _happy(1000)),
    ("abundant-numbers", "Abundant Numbers", "The first 1,000 abundant numbers.", _abundant(1000)),
    ("deficient-numbers", "Deficient Numbers", "The first 2,000 deficient numbers.", _deficient(2000)),
    ("palindromic-numbers", "Palindromic Numbers", "The first 1,000 palindromic numbers.", _palindromic(1000)),
    ...
    ("even-numbers", "Even Numbers", "The first 10,000 even numbers.", [2 * n for n in range(1, 10001)]),
    ("odd-numbers", "Odd Numbers", "The first 10,000 odd numbers.", [2 * n - 1 for n in range(1, 10001)]),
